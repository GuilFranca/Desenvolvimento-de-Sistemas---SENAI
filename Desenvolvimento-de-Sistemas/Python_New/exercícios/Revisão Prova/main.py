...
# json é utilizado para o gerenciamento de dados
import json
# os é utilizado neste código para encontrar um arquivo json
import os
...
class Aluno:
    ...
    def calcularMedia(self):
        if self._notas:
            # sum - soma todos os valores presentes na lista
